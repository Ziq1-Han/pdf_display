...
@app.route('/api/pdf12', methods=['GET'])
def serve_pdf():
    sku_list = []
    ...
    filename = sorted(glob.glob(os.path.join(pdf_folder_path,'Shopping'+'*'+str(sku_list[0])+'*.pdf')))  # Specify the name of the PDF file to be served
