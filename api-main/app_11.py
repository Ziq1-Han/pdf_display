...
@app.route('/api/pdf11', methods=['GET'])
def serve_pdf():
    sku_list = []
    ...
    filename = sorted(glob.glob(os.path.join(pdf_folder_path,'Packing'+'*'+str(sku_list[0])+'*.pdf')))  # Specify the name of the PDF file to be served
