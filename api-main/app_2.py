...
@app.route('/api/pdf2', methods=['GET'])
def serve_pdf():
    order_list = []
    ...
    filename = sorted(glob.glob(os.path.join(pdf_folder_path,'*'+str(order_list[1])+'*.pdf')))  # Specify the name of the PDF file to be served
