...
@app.route('/api/pdf1', methods=['GET'])
def serve_pdf():
    order_list = []
    ...
    filename = sorted(glob.glob(os.path.join(pdf_folder_path,'*'+str(order_list[0])+'*.pdf')))  # Specify the name of the PDF file to be served
