...
@app.route('/api/pdf21', methods=['GET'])
def serve_pdf():
    ...
    filename = sorted(glob.glob(os.path.join(pdf_folder_path,'Packing'+'*'+str(sku_list[1])+'*.pdf')))  # Specify the name of the PDF file to be served
